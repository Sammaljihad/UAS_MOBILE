...
import com.example.tokoapp.adapter.AdapterBank
import com.example.tokoapp.app.ApiConfig
import com.example.tokoapp.helper.Helper
import com.example.tokoapp.model.Bank
import com.example.tokoapp.model.Chekout
...
class PembayaranActivity : AppCompatActivity() {
    ...
    fun displayBank() {
        ...
        arrBank.add(Bank("BCA", "092093871237", "ADE GANTENG", R.drawable.logo_bca))
        arrBank.add(Bank("BRI", "86721349128", "ADE GANTENG", R.drawable.logo_bri))
        arrBank.add(Bank("Mandiri", "02394870329", "ADE GANTENG", R.drawable.logo_madiri))
